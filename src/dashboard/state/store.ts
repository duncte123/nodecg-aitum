import { replicantModule, ReplicantModule, ReplicantTypes } from '@nodecg-aitum/browser_shared/replicant_store';
import { ExampleReplicant } from '@nodecg-aitum/types/schemas';
